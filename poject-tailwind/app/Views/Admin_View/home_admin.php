<?= $this->extend('Template/admin_view') ?>
     ...
     <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div class="relative flex items-center justify-between h-16">
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <button class="px-4 py-2 text-gray-700 text-2xl rounded-lg hover:bg-gray-200">
            ...
            <div class="ml-3 relative">
                ...
                <!-- Popup Bell -->
                <div class="hidden origin-top-left absolute right-0 mt-0 w-64 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
            ...
            <div class="ml-3 relative">
                ...
                <!-- Popup Bell -->
                <div class="hidden origin-top-left absolute right-0 mt-0 w-20 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-10">
                    <p class="p-2 text-sm text-gray-700">Warna</p>
                    <div class="py-2">
                        <button class="bg-blue-500 w-12 h-8 rounded block mx-auto my-1"></button>
                        <button class="bg-indigo-500 w-12 h-8 rounded block mx-auto my-1"></button>
                        <button class="bg-green-500 w-12 h-8 rounded block mx-auto my-1"></button>
                        <button class="bg-red-500 w-12 h-8 rounded block mx-auto my-1"></button>
                        <button class="bg-gray-800 w-12 h-8 rounded block mx-auto my-1"></button>
                    </div>
                </div>
                <!-- Akhir Icon -->
            </div>
            ...
            <div class="ml-3 relative">
                ...
                <div>
                    <button type="button" class="bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                        ...
                        <img src="" class="h-8 w-8 rounded-full">
                    </button>
                </div>
